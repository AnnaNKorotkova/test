...
//    void subscribe(PriceProcessor priceProcessor);
    /**
     * We should realize Observer Pattern to solve Subscribe/Unsubscribe message model, then its a not good
     * decision to take PriceProcessor for subscribe and unsubscribe subscriber for send messages.
     * We can also use some broker system (for example RabbitMQ)  for solving this issie.
    * */
